---
title: "Developmental changed in Statistical Word Learning"
...
`r e1_low_language_n` children then excluded due to hearing <`r MIN_LANG`% English at home, and `e1_r exclude_example_n` additional children were dropped from further analysis due to incorrect responses on at least 1 example trial, leaving us in doubt about whether they understood the task. 
...
ggplot(e1_age_trial_data, aes(x = age_group, y = mean, color = trialType, 
  ...
  scale_x_continuous(limits=c(2.8,5.3), name = "Age Group") + 
...
`r e2_low_language_n` children then excluded due to hearing <`r MIN_LANG`% English at home, and `e2_r exclude_example_n` additional children were dropped from further analysis due to incorrect responses on at least 1 example trial, leaving us in doubt about whether they understood the task. 
